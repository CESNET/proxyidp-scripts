...
echo "SAML Auth test active - ${STATUS_TXT} [MUNI STATUS - ${MUNI_RESULT}(${MUNI_LOGIN_TIME}s); CESNET STATUS - ${CESNET_RESULT}(${CESNET_LOGIN_TIME}s)] | muni_login_time=${MUNI_LOGIN_TIME} cesnet_login_time=${CESNET_LOGIN_TIME}"
exit ${STATUS}
